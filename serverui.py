...
qtCreatorFile = "server.ui" # Enter file here.
m = 8
...
class MyApp(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def host(self):
        ...
        print 'helooo'
        self.thr = client(clientsocket, address)
        print 'server ok'
        return
